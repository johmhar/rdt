...
public class RDTLayer3_1  extends VirtuaaliSoketti {
    private byte lastSeq;
    private byte lastSentSeq;

    public RDTLayer3_1() throws SocketException {
        super();
        this.lastSeq = -1;
        this.lastSentSeq = 1;
        setSoTimeout(5000);
    ...
    public RDTLayer3_1(int portti) throws SocketException{
        super(portti);
        this.lastSeq = -1;
        this.lastSentSeq = 1;
    }
    ...
    public void rdtSend(String input, int port) throws IOException {
        ...
        while(true) {
            ...
            try {
                ...
                System.out.print("*** RDT layer - NAK [" + length + "]: ");
                ...
                // Timer off, no NAK received, back to above!
    ...
    public void receive(DatagramPacket paketti) throws IOException {
        ...
        while(true) {
            ...
            if (result) {
                // Forward packet to above, no ACK sent...
                return;
            }
        }
    }
